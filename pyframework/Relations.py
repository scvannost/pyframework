...
class ForeignKey(AbstractConstraint):
	def __init__(self, target_table: Table, target_column: Column, foreign_table: Table, foreign_column: Column):
		...
		AbstractConstraint._add_to_column(self, self._foreign_table, self._foreign_column)
